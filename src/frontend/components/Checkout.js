            ...
            <form action="#">
              ...
              <div className="mb-4 pr-4">
                ...
                <input
                  ...
                  required="required"
                  className="w-full border border-gray-300 rounded-none py-2 px-3 focus:outline-none focus:border-green-500"
                  defaultValue={user?.email || ""} // Use user data if available
                />
              </div>
              ...
              <div className="mb-4 pr-4">
                ...
                <input
                  ...
                  required="required"
                  className="w-full border border-gray-300 rounded-none py-2 px-3 focus:outline-none focus:border-green-500"
                  defaultValue={user?.phone || ""} // Use user data if available
                />
              </div>
              ...
              <div className="mb-4 pr-4">
                ...
                <input
                  ...
                  required="required"
                  className="w-full border border-gray-300 rounded-none py-2 px-3 focus:outline-none focus:border-green-500"
                  defaultValue={user?.country || ""} // Use user data if available
                />
              </div>
              ...
              <div className="mb-4 pr-4">
                ...
                <input
                  ...
                  required="required"
                  className="w-full border border-gray-300 rounded-none py-2 px-3 focus:outline-none focus:border-green-500"
                  defaultValue={user?.zip || ""} // Use user data if available
                />
              </div>
          ...
          <div className="ml-5 bg-white p-5">
            ...
            <ul>
              <li className="py-2 border-b border-gray-200 text-gray-600 leading-8">
                Subtotal
                <span className="float-right ml-20">${totalcost}</span>
              </li>
              <li className="py-2 border-b border-gray-200 text-gray-600 leading-8">
                Shipping
                <span className="float-right ml-20">${shipping}</span>
              </li>
              <li className="py-2 text-gray-600 leading-8">
                <b className="font-bold">Payable Total</b>
                <span className="float-right ml-20">
                  <b className="font-bold">${totalcost + shipping}</b>
                </span>
              </li>
            </ul>
          </div>
